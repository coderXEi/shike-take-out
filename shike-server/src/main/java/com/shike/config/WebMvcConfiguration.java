...
public class WebMvcConfiguration extends WebMvcConfigurationSupport {
    ...
    public Docket docket1() {
        ApiInfo apiInfo = new ApiInfoBuilder()
                .title("食客平台项目接口文档")
                .version("2.0")
                .description("食客平台项目接口文档")
                .build();
        Docket docket = new Docket(DocumentationType.SWAGGER_2)
                .groupName("管理端接口")
                .apiInfo(apiInfo)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.shike.controller.admin"))
    ...
    public Docket docket2() {
        ...
        Docket docket = new Docket(DocumentationType.SWAGGER_2)
                ...
                .apiInfo(apiInfo)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.shike.controller.user"))
                .paths(PathSelectors.any())
                .build();
        return docket;
    }
